...
(function () {
    (function (e, t, n) {
        ...
        r.prototype.init = function () {
            ...
            e.data(this, "total", n.children().not(".sidBar", n).length);
            ...
            n.slidesContainer = n.children().not(".sidBar", n).wrapAll("<div class='slidesjs-container'>", n).parent().css({
                overflow: "hidden",
                position: "relative"
            });
            ...
            if (this.options.navigation.active) {
                o = e("<a>", {"class": "prev sidBar", href: "#", title: "Previous", text: ""}).appendTo(n);
                r = e("<a>", {"class": "next sidBar", href: "#", title: "Next", text: ""}).appendTo(n)
            }
            e(".next", n).click(function (e) {
                e.preventDefault();
                a.stop(!0);
                return a.next(a.options.navigation.effect)
            });
            e(".prev", n).click(function (e) {
                e.preventDefault();
                a.stop(!0);
                return a.previous(a.options.navigation.effect)
            });
            if (this.options.play.active) {
                s = e("<a>", {"class": "slidesjs-play sidBar", href: "#", title: "Play", text: "Play"}).appendTo(n);
                u = e("<a>", {"class": "slidesjs-stop sidBar", href: "#", title: "Stop", text: "Stop"}).appendTo(n);
                s.click(function (e) {
                    e.preventDefault();
                    return a.play(!0)
                });
