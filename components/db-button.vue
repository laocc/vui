...
module.exports = {
    ...
    created() {
        ...
        if (!this.action || this._events.drawer) {
    ...
    computed: {
        ...
        titleVal: function () {
            ...
            } else if (this.title === '' && this.$slots.default) {
    ...
    methods: {
        ...
        clickBtn(e) {
            if (this.type) this.action = this.type;
            ...
            if (this._events.submit) {
                ...
                this.$emit('submit', e, this.data);
                return;
            } else {
                this.$emit('click', e, this.data);
            }
            ...
            if (this.action === 'ajax' || this.action === 'post') {
                ...
                this.$emit('input', option, this.data);
                ...
                this.drawerCall ? this.$emit('drawer', option, this.data) : Object.assign(this.value, option);
                this.$emit('input', option, this.data);
                        ...
                        let back = function (v) {
                            ...
                            if (resp.reload || resp.self === 'reload') {
                                ...
                                if (self._events.finish) {
                                    self.$emit('finish', resp, self.data);
                                } else {
